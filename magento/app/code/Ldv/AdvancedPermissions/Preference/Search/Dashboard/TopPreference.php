 ...
 */
class TopPreference extends Top
{
    /**
     * @var UserConfig
     */
    ...
    protected function _prepareCollection()
    {
        ...
        if (is_array($storeIds)) {
            $storeIds = array_unique(array_merge($storeIds, $allowedStoreIds));
        } elseif (!empty($storeIds)) {
            array_push($allowedStoreIds, $storeIds);
            $storeIds = array_unique($allowedStoreIds);
        } else {
